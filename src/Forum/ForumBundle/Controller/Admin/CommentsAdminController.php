...
class CommentsAdminController extends Controller
{
     ...
     * @Route("/all", name="all_comments_admin")
    ...
    public function allCommentsAction(Request $request)
    {
        ...
        return $this->render('@Forum/admin/componentAd/comment-item.html.twig', array(
            'comments' => $comments));
    }

    /**
     * @Route("/{id}",name="comment_add_admin")
     */
    ...
    /**
     * @Route("remove/{subject}/{comment}" , name="remove_comment_admin")
     */
